        ...
        child: Stack(
          ...
          children: [
              ...
              child: Center(
                child: Padding(
                  padding: EdgeInsets.only(
                      top: MediaQuery.of(context).size.height / 11.2),
                  child: Column(
                    children: [
                      Text(
            ...
            Positioned(
                ...
                // top: -64.5,
                child: Image(image: AssetImage('assets/images/Ellipse_1.png'))),
            Positioned(
                left: MediaQuery.of(context).size.width / 3.45,
                right: MediaQuery.of(context).size.width / 3.45,
                bottom: MediaQuery.of(context).size.height / 4.82,
                // top: -50.5,
                child: Image(image: AssetImage('assets/images/Ellipse_2.png'))),
            Positioned(
                left: MediaQuery.of(context).size.width / 3.04,
                right: MediaQuery.of(context).size.width / 3.04,
                bottom: MediaQuery.of(context).size.height / 4.44,
                // top: -35.5,
                child: Image(image: AssetImage('assets/images/Ellipse_3.png'))),
            Positioned(
              left: MediaQuery.of(context).size.width / 2.9,
              bottom: MediaQuery.of(context).size.height / 4.27,
              child: Icon(Icons.check_sharp,
                  color: AppColors.colorWhite, size: 40),
