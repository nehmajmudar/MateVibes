...
class RowOfUserProfile extends StatefulWidget {
  ...
  const RowOfUserProfile({
    Key? key,
    required this.noOfPosts,
    required this.noOfMedia,
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Column(
              children: [
                Text(AppString.txtNoOfPosts,
                    style: TextStyle(
                        fontSize: 14,
                        color: AppColors.colorLetsGetStarted,
                        fontWeight: FontWeight.w800,
                        fontFamily: 'Manrope')),
                Text("${widget.noOfPosts}",
                    style: TextStyle(
                        fontSize: 12,
          ...
          Container(
            ...
            child: Column(
              children: [
                Text(AppString.txtMedia,
                    style: TextStyle(
                        fontSize: 14,
                        color: AppColors.colorLetsGetStarted,
                        fontWeight: FontWeight.w800,
                        fontFamily: 'Manrope')),
                Text("${widget.noOfMedia}",
                    style: TextStyle(
                        fontSize: 12,
                        color: AppColors.colorTimeOfPost,
                        fontWeight: FontWeight.w800,
          ...
          Container(
            ...
            child: Column(
              children: [
                Text(AppString.txtFollowing,
                    style: TextStyle(
                        fontSize: 14,
                        color: AppColors.colorLetsGetStarted,
                        fontWeight: FontWeight.w800,
                        fontFamily: 'Manrope')),
                Text("${widget.noOfFollowing}",
                    style: TextStyle(
                        fontSize: 12,
                        color: AppColors.colorTimeOfPost,
                        fontWeight: FontWeight.w800,
          ...
          Column(
            children: [
              Text(AppString.txtFollowers,
                  style: TextStyle(
                      fontSize: 14,
                      color: AppColors.colorLetsGetStarted,
                      fontWeight: FontWeight.w800,
                      fontFamily: 'Manrope')),
              Text("${widget.noOfFollowers}",
                  style: TextStyle(
                      fontSize: 12,
                      color: AppColors.colorTimeOfPost,
                      fontWeight: FontWeight.w800,
