                      ...
                      children: [
                          ...
                          children: [
                            CircleAvatar(
                              backgroundImage: AssetImage(
                                  'lib/assets/images/user_profile_img.png'),
                            ),
                            Column(
                              children: [
                                Container(
                        ...
                        Container(
                          margin: EdgeInsets.only(
                              ...
                              bottom:
                                  MediaQuery.of(context).size.height / 31.25),
                          child: Text(
                            AppString.txtLoremIpsum,
                            softWrap: true,
                            maxLines: 10,
                            style: TextStyle(
                                fontSize: 11,
                        ...
                        StaggeredGrid.count(
                          ...
                          children: [
                            ...
                            StaggeredGridTile.count(
                                ...
                                child: Image(
                                  image: AssetImage(
                                      'lib/assets/images/MateVibes_logo.png'),
                                  fit: BoxFit.fill,
                                )),
                            StaggeredGridTile.count(
                                crossAxisCellCount: 1,
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.only(
                              ...
                              bottom:
                                  MediaQuery.of(context).size.height / 65.57),
