class AppString {
  ...
  static String txtcheckYourPassword = "Please check and correct your password";
  static String txtcorrectYourMailandPassword =
      "Please Correcct your username or Password";
